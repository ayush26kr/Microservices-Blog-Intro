...
<html lang="en">
<head>
    <title>Code coverage report for oy/lib/Stats.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">oy/lib/Stats.js</span></h1>
    <h2>
        
        Statements: <span class="metric">94.55% <small>(52 / 55)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">oy/lib/</a> &#187; Stats.js</div>
</div>
<div class="body">
...
Stats.isValidJourney = function(from, to) {
  ...
  <span class="missing-if-branch" title="if path not taken"" >I</span>if(!fromType) {
...
Stats.findJourneySummary = function(journey) {
  <span class="missing-if-branch" title="if path not taken"" >I</span>if(!journey) { <span class="cstat-no" title="statement not covered" >return; </span>}
  return _.find(Stats.journeys, function(item) {
    <span class="missing-if-branch" title="else path not taken"" >E</span>if(journey.to) {
      return _.isEqual(journey.from, item.from) &amp;&amp; _.isEqual(journey.to, item.to);
    } else {
<span class="cstat-no" title="statement not covered" >      return _.isEqual(journey.from, item.from);</span>
    }
  });
};
&nbsp;
...
Stats.updateJourneySummary = function(journey) {
  ...
  <span class="missing-if-branch" title="else path not taken"" >E</span>if(journey.startDate) {
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Sun Dec 22 2013 10:32:41 GMT+0000 (GMT)</div>
</div>
